    ...
    <>
      <Router>
        <Switch>
          ...
          <PrivateRouter path="/promotion" component={PromotionScreen} />
          <PrivateRouter path="/addpromotion" component={AddPromotion} />
          <PrivateRouter path="/promotion/:id/edit" component={PromotionDetailScreen} />
